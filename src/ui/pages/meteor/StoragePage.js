var _, bucketSearchChanged, connect, copyBucketRequest, deleteBucketRequest, mapDispatchToProps, mapStateToProps, openBucketPageRequest, pretty;
...
mapStateToProps = function(state, {params}) {
  ...
  return {
    ...
    totalResults: ((ref1 = state.collections.buckets) != null ? ref1.length : void 0) || 0,
