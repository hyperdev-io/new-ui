...
App = React.createClass({
  ...
  switchSideBar: () =>
    this.setState({priority: (this.state.priority === 'right' ? 'left' : 'right')}),
  render: function(){
    return (
          ...
          <G.Sidebar colorIndex='neutral-1'>
            ...
            <G.Footer pad={{horizontal: 'medium', vertical: 'small'}} align='center' direction='row'>
              {this.props.isLoggedIn ?
                <Button align='start' plain={true} onClick={this.props.onLogout} icon={<Icons.Base.Logout />}></Button>
...
const { userErrorAcknowledged } = require('/imports/redux/actions/errors.coffee');
const { logout } = require('/imports/redux/actions/user.coffee');
