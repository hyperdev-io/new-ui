let Box, Button, Header, Heading, Icons, ListItem, Paragraph, Search, Sidebar, Split, Title;
      ...
      <span>
        <Split flex='left' priority='left'>
          <FilterableListPage title='Storage'
            ...
            selectedIdx={_.findIndex(this.props.buckets, (b)=> b.name === this.props.selectedBucket)}
        ...
        <BucketCopyLayer
          ...
          onClose={() => this.props.onActionMenuClose(this.props.selectedBucket)}
